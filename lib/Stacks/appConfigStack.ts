...
export class AppConfigStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: AppConfigStackProps) {
    ...
    const appConfigEnvironment = new appconfig.CfnEnvironment(
      this,
      APPCONFIG_CONSTANTS.environment_name,
      {
    ...
    const appConfigVersion = new appconfig.CfnHostedConfigurationVersion(
      this,
      `AppConfig-Version`,
      {
        applicationId: appConfigApplication.ref,
    ...
    const deploymentStrategy = new appconfig.CfnDeploymentStrategy(
      this,
      "Custom-5Min50Percent",
      {
        name: APPCONFIG_CONSTANTS.deployment_name,
        deploymentDurationInMinutes:
          APPCONFIG_CONSTANTS.deploymentDurationInMinutes,
    ...
    const configVersion = new appconfig.CfnDeployment(
      this,
      "AppConfigDeployment",
      {
        applicationId: appConfigApplication.ref,
